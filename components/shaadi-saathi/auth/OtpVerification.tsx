      ...
      >
        {digits.map((d, i) => (
          <input
            ...
            className="shaadi-auth-input h-14 w-full min-w-0 max-w-[3.5rem] flex-1 basis-0 rounded-xl border border-gold/25 bg-ivory text-center text-xl font-semibold text-maroon-dark sm:h-16"
          />
        ))}
      </div>
