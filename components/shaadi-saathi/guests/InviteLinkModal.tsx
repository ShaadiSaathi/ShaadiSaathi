...
import { Input, Label } from "@/components/shaadi-saathi/ui/Input"
...
export default function InviteLinkModal({
  ...
  return (
    <Modal
      titleId="invite-link-title"
      title={isGroup ? `Share group invite for ${guestName}` : `Send invite to ${guestName}`}
      description={
        isGroup
    ...
    >
      <div className="mt-4">
        <Label htmlFor="invite-url" className="text-xs">
          Invite link
        </Label>
        <Input
          id="invite-url"
      ...
      <div className="mt-4 flex flex-col gap-2 sm:flex-row">
        ...
        <a
          ...
          className="inline-flex flex-1 items-center justify-center gap-2 rounded-full bg-[#25D366] px-4 py-2.5 text-sm font-semibold text-white transition-opacity hover:opacity-90"
        >
