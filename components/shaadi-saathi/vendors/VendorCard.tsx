    ...
    >
      ...
      <div className="p-4 sm:p-5">
        <div className="flex items-start justify-between gap-3">
          ...
          {(vendor.completedJobsCount ?? 0) > 0 && vendor.rating > 0 ? (
            ...
            <span className="shrink-0 rounded-full border border-gold/25 bg-gold/8 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-gold-dark">
              New
            </span>
          )}
        </div>
